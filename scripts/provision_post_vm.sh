...
#cd /home/vagrant/playbooks/ansible-vm
#exe "Running ansible-vm playbook on vm" \
#     bash -c 'ansible-playbook -v -i hosts site.yml 1>/home/vagrant/.log/ansible-vm.vm 2>&1'
#
#exe "Running ansible-vm playbook on CnC" \
#     bash -c 'ansible-playbook -v -i hosts.local site.yml 1>/home/vagrant/.log/ansible-vm.cnc 2>&1'
#
